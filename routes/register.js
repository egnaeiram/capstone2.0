...
const Register = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
        ...
        <FontAwesomeIcon icon={faInfoCircle} />
        8 to 24 characters, must contain at least one of each:<br />
        lowercase letter, uppercase letter, number, and special character.
        Allowed special characters: <span aria-label="exclamation mark">!</span>
        <span aria-label="at symbole">@</span> <span aria-label="hashtag symbole">#</span>
        <span aria-label="dollar symbole">$</span> <span aria-label="percentage symbole">%</span>
        </p>
